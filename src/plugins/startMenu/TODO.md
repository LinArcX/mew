...
- [ ] put KeyBindings in start menu under mewConf menu. (so, KeyBindings should be sub-menu of mewConf finally)

- [ ] the order of items in start menu from bottom to top would be like this:
  - PowerManager
  - appLauncher
  - mewConf
